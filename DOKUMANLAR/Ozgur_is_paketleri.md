...
| İP14 | ✅ | 01.09.2026 | `scripts/ip14_canli_tur.py` v2 (evrensel kaynak): KaynakAdaptoru (video/RTSP/webcam/statik), SSIM statik mod + MOG2 video mod, WP03 ref-warmup düzeltmesi, 3/3 uyarı doğru tespit, MQTT offline, PDF üretildi. Çıktı: outputs/ip14_canli_tur/ |
| İP15 | ✅ | 01.09.2026 | `scripts/ip15_harita_konumlandir.py` oluşturuldu. altin_tur_v2.mp4'ten optik akış ile 2D ego-motion harita; uyarı noktaları (WP01/WP02/WP03) harita üzerine severity rengiyle işaretlendi. Dashboard JSON + PDF dizinine harita PNG entegre. Çıktı: outputs/ip15_harita/ |
| İP16 | ⬜ | | |
