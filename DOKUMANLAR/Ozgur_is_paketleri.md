...
| İP14 | ✅ | 01.09.2026 | `scripts/ip14_canli_tur.py` oluşturuldu. engel.mp4 simülasyon modu: WP01/WP02/WP03 sırayla ziyaret → MOG2 analiz → MQTT offline yayın → İP13 PDF otomatik üretildi. Çıktı: outputs/ip14_canli_tur/ · PDF: outputs/devriye_raporu/son_devriye_raporu.pdf |
