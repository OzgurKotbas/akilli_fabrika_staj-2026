...
## Eyl�l 2026 - Demo V2 ve Mimari Entegrasyonu

- [x] **Ortak Demo (run_demo.py) V2 S�r�m� Geli�tirildi:**
  - Bedirhan (Alg�lama), Re�it (G�sterge) ve �zg�r (Anomali) mod�lleri tek bir un_demo.py dosyas�nda birle�tirildi.
  - T�m mod�ller i�in MQTT yay�nlama yetene�i eklendi. (patrol/alert, ision/target_offset, inspect/reading)
  - Broker bulunamad���nda hata vermek yerine JSONL dosyalar�na loglama yapacak Offline mod eklendi.
- [x] **Hareketli Kamerada 3D Parallax Problemi ��z�ld� (Optik Ak��):**
  - Demo testlerinde robotun koridorda y�r�mesi s�ras�nda olu�an derinlik kaymalar�n�n (3D Parallax) MOG2'yi tetikleyerek 150+ sahte anomali (False Positive) �retti�i tespit edildi.
  - Donan�msal tekerlek sens�r� olmad��� i�in, **Optik Ak�� (Lucas-Kanade Optical Flow)** kullan�larak Ego-Motion hesaplayan bir sim�lasyon yaz�ld�.
  - Piksellerin kayma miktar� 1.5px'i a�t���nda robotun hareket etti�i anla��larak Anomali taramas� (MOG2) uyku moduna al�nd�. FP oran� %0'a indirildi.
- [x] **Kategori Tabanl� Anomali Skorlamas� (�P13):**
  - Tespit edilen anomaliler boyut (W/H oran�) ve renk (HSV) de�erlerine g�re YAPI_ANOMALISI (dikey, ince), ZEMIN_SIZINTISI (karanl�k, yayvan) ve YABANCI_NESNE olarak etiketlendi.
- [x] **Github Reposu Temizli�i:**
  - un_demo.py scripti ana dizine al�nd�, ba�kas�na ait test ve ba��ml�l�k klas�rleri (asrav_gauge_repo, vb.) Github'dan kald�r�larak .gitignore'a eklendi.
